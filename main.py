...
def busca_google_shopping(nav, produto, termos_banidos, preco_minimo, preco_maximo):
    ...
    elemento_pesquisa = 'REsRA'
    nav.find_element(By.ID, elemento_pesquisa).send_keys(produto)
    nav.find_element(By.ID, elemento_pesquisa).send_keys(Keys.ENTER)
...
def busca_buscape(nav, produto, termos_banidos, preco_minimo, preco_maximo):
    ...
    pesquisa = 'AutoCompleteStyle_input__WAC2Y.AutoCompleteStyle_textBox__glAfE.AutoCompleteStyle_input__WAC2Y'
    nav.find_element(By.CLASS_NAME, pesquisa).send_keys(produto, Keys.ENTER)
...
for linha in tabela_produtos.index:
    ...
    if lista_ofertas_google_shopping:
        ...
        tabela_ofertas = tabela_ofertas = pd.concat([tabela_ofertas, tabela_google_shopping], ignore_index=True)
    else:
    ...
    if lista_ofertas_buscape:
        ...
        tabela_ofertas = tabela_ofertas = pd.concat([tabela_ofertas, tabela_buscape], ignore_index=True)
    else:
        tabela_buscape = None
...
if len(tabela_ofertas.index) > 0:
    ...
    mail.To = 'solucoes.inovadoras10+neto@gmail.com'
